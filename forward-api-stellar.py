...
setup_logging('mlsapp/mlsgrid/logs/stellar-api-forward.log')
...
def PostApi(raw_text):
    ...
    try:
        ...
        if response.status_code == 200:
            logger.info(f'Stellar data forwarded to api detail {raw_text[:250]}')
        else:
...
def get_columns():
    ...
    try:
        ...
        logger.error(f"Error executing SHOW COLUMNS query for Property table stellar forward api: {e}")
        property_columns = []
    ...
    try:
        ...
        logger.error(f"Error executing SHOW COLUMNS query for Member table forward api stellar: {e}")
        member_columns = []
    ...
    try:
        ...
        logger.error(f"Error executing SHOW COLUMNS query for Media table forward api stellar: {e}")
        media_columns = []
    ...
    try:
        ...
        logger.error(f"Error executing SHOW COLUMNS query for PropertyUnitTypes table forward api stellar: {e}")
        unit_columns = []
    ...
    try:
        ...
        logger.error(f"Error executing SHOW COLUMNS query for PropertyRooms table forward api stellar: {e}")
        room_columns = []
...
def main():
    ...
    while True:
        ...
        with open('batch_file_stellar.txt','w') as file: 
